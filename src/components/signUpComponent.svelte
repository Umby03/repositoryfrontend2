...
<form style="width:300px;">
	...
	<div class="mb-3">
		<label for="password" class="form-label"style="margin-bottom:0%"><h5>Ripeti Password</h5></label>
...
<br>
	<div class="btn btn-link"style="color:black; padding:0px; margin-top:20px; margin-bottom:10px;" on:click={toggleHasAccount}>
		Ho un Account
	</div>
</center>
</form>